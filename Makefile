...
# translation
SOURCES = quadstreaker.py ui_quadstreaker.py __init__.py quadstreakerdialog.py
#TRANSLATIONS = i18n/quadstreaker_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = quadstreaker

PY_FILES = quadstreaker.py quadstreakerdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_quadstreaker.py
